...
Now I will run the random forest model fit on the training set. I use 175 trees. When I used 200 trees, it requires more memory than my computer could handle. 
```{r}
set.seed(95348)
...
We find that 90.40% of the test data was classified correctly.
...
We find that 90.75% of the test data was classified correctly, just a little higher accuracy than the logistic regression model. 
