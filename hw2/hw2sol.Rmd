...
**Solution Notes:**
- summary using graphs + some numerics
...
icustays_tble %>% 
  ...
  nrow()
```
It seems that each row is a unique ICU stay. (number of rows is the same as the number of rows of original tibble)

Can the same person have multiple stays?
Check number of un
## Q4. `admission` data
